...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
    //Pull out the phase constants that need to be calculated repeatedly
    //Change 'querySelectorAll' to 'getElementsByClassName' to become faster
    var dx = determineDx(document.getElementsByClassName("randomPizzaContainer")[0], size);
    var newwidth = (document.getElementsByClassName("randomPizzaContainer")[0].offsetWidth + dx) + 'px';
    numOfPizzaContainers = document.getElementsByClassName("randomPizzaContainer").length;
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // Too many pizzas, 40 pizzas are enough
  for (var i = 0; i < 40; i++) {
